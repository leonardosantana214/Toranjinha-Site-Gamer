...
<head>
	...
	<link rel="shortcut icon" href="Frutas/Logo.png" type="image/x-icon">
...
<body>
	...
	<div id="loader-wrapper">
		<div class="animate__animated animate__fadeInDownBig animate__slower" id="loader">


			<img src="https://i.pinimg.com/originals/1e/85/d8/1e85d85797303b24c110f39e72ce3de2.gif"
				style="	width: 500px; height: 500px; margin-bottom: -250px; z-index: 100000; filter: drop-shadow((10px 10px 10px gray)); margin-right: 140px;"
				alt="loading">
			<img src="https://art.pixilart.com/00a282a3eeceb97.gif"
				style="	width: 600px; height: 600px; margin-bottom: 100px;" alt="loading2">
			...
			<div class="animated-box">
					...
					<h1>
						...
						if (!empty($_SESSION['nome'])) {
							echo '<p style="flex-direction: row;">
								Seja bem-vindo ' . $username_toshow . '<img src="frutas/' . $_SESSION["image"] . '" Align="center" class="img-user"
				...
				<nav id="primary">
					<ul>
						<li>
							<h1>MODO ESCURO</h1>
							<a class="manned-flight" id="modoEscuroBtn">
								<img src="https://i.pinimg.com/originals/79/ea/6f/79ea6ffa1ca3345b59042a9ce9638dfc.gif"
									alt="Modo Escuro" id="modoEscuroImg"></a>
						</li>
						<li>
							<h1>HOME</h1>
							<a class="manned-flight" href="#manned-flight"><img src="img/Pukemon.gif" alt=""></a>
						</li>
						<li>
							<h1>LOJA DO TORANJINHA</h1>
							<a class="frameless-parachute" href="#frameless-parachute"><img
									src="https://i.pinimg.com/originals/0b/7a/cc/0b7acc43ae7c3a5ae35654fdf1b9bc4b.gif"
									alt=""></a>
						</li>
						<li>
							<h1>JOGOS DO TORANJAS</h1>
							<a class="english-channel" href="#english-channel"><img
									src="https://i.pinimg.com/originals/10/27/f8/1027f80aeabcbb74a2e698be71829e9e.gif"
									alt=""></a>
						</li>
						<li>
							<h1>SUA CONTA DO TORANJAS</h1>
							<a class="about" href="#about"><img
									src="https://i.pinimg.com/originals/66/2c/da/662cda1ea6bdac6afb16973961c2c8d1.gif"
									alt=""></a>
						</li>
					</ul>
				</nav>
				...
				<div id="content">
					<article id="manned-flight">
						...
						<hr />
						<a href="Sobre-nos.html" class="btn-Link">Sobre-nos</a>
					...
					<article id="frameless-parachute">
						...
						<a href="TORANJA 2.0.php" class="btn-Link">Ver a Loja</a>
						<nav class="next-prev">
					...
					<article id="english-channel">
						...
						<a href="TELA DE JOGOS.php" class="btn-Link">Acessar aos jogos</a>
					...
					<article id="about">
						...
						<?php if ($_SESSION['email'] != ""): ?>
							<div class="user-info">
								<?php $imagem = $_SESSION['image']; ?>
								<img src="frutas/<?php echo $_SESSION['image']; ?>" Align="center" id="img-user"
									alt="Imagem do usuário" style="border-radius:50%; margin-right:20px; " width="100px"
									height="100px">
							...
							<?php if ($_SESSION['email'] == 'Toranjas@toto.com'): ?>
								<button id="Add-btn" class="btn-Link"
									style="left: 205px; position: absolute; width:6%; height:4%; justify-content:center; text-align:center; display:flex; justify-content:center; align-items:center; bottom:111px; color:orangered;">Add</button>
							...
							<a href="editprofile.php" class="btn-Link">Editar Perfil</a>

							<button type="buttom" id="abrir-carrinho" class="btn-Link"
								style="margin-left:10px; color:orangered; width:45px; height:40px;">
				...
				background-color: orange;">Comprar</button>
							...
							<form action="process.php" method="POST">
								...
								<button type="submit" class="btn-Link"
									style="width:150px; height:40px; color:red;">Logout</button>
							</form>
						...
						<?php else: ?>
							<div class="login-options">
								...
								<a href="LoginToranjão.php" class="btn-Link">Fazer Login</a>
							</div>
						<?php endif; ?>
						<nav class="next-prev">
				...
				<div id="parallax-bg3">
					<img id="bg3-1"
						src="https://66.media.tumblr.com/33d5fb884ba350b0495501625d07da03/tumblr_mqatxtNyuW1rfjowdo1_500.gif"
						width="529" height="557" alt="Montgolfier hot air balloon" />
					<img id="bg3-2" src="https://i.pinimg.com/originals/15/26/5a/15265af91d058d33da9d448a7cd070f9.gif"
						width="603" height="583" alt="Frameless parachute" />
					<img id="bg3-3"
						src="https://media3.giphy.com/media/iJsjsm6dhNPiQBvztq/200w.gif?cid=6c09b952j2m0vilymz1682k52w5eupz1ft9gqetod287py74&ep=v1_gifs_search&rid=200w.gif&ct=s"
						width="446" height="413" alt="Blanchard's air balloon" />
					<img id="bg3-4" src="https://i.pinimg.com/originals/9d/dd/0c/9ddd0cf77c1d495dd57e8ca2a37a7906.gif"
						width="400" height="500" alt="Landscape with trees and cows" />
				...
				<div id="parallax-bg2">
					<img id="bg2-1"
						src="https://media2.giphy.com/media/FHcRX5OWtvIaKTWyTX/giphy.gif?cid=6c09b952ys9xz0oihx6vzec3i9ond0dgxxn5vll8gfnk0riy&ep=v1_stickers_related&rid=giphy.gif&ct=s"
						height="40" width="40" alt="cloud" />
					<img id="bg2-2" src="https://i.pinimg.com/originals/29/a2/22/29a222d0e480acf061b959b933ede8e9.gif"
						alt="cloud" />
					<img id="bg2-3"
						src="https://media2.giphy.com/media/FHcRX5OWtvIaKTWyTX/giphy.gif?cid=6c09b952ys9xz0oihx6vzec3i9ond0dgxxn5vll8gfnk0riy&ep=v1_stickers_related&rid=giphy.gif&ct=s"
						height="40" width="40" alt="cloud" />
					<img id="bg2-4" src="https://i.pinimg.com/originals/29/a2/22/29a222d0e480acf061b959b933ede8e9.gif"
						alt="cloud" />
					<img id="bg2-5"
						src="https://media2.giphy.com/media/FHcRX5OWtvIaKTWyTX/giphy.gif?cid=6c09b952ys9xz0oihx6vzec3i9ond0dgxxn5vll8gfnk0riy&ep=v1_stickers_related&rid=giphy.gif&ct=s"
						alt="cloud" />
				...
				<div id="parallax-bg1">
					<img id="bg1-1" src="https://i.pinimg.com/originals/29/a2/22/29a222d0e480acf061b959b933ede8e9.gif"
						alt="cloud" />
					<img id="bg1-2"
						src="https://media2.giphy.com/media/FHcRX5OWtvIaKTWyTX/giphy.gif?cid=6c09b952ys9xz0oihx6vzec3i9ond0dgxxn5vll8gfnk0riy&ep=v1_stickers_related&rid=giphy.gif&ct=s"
						alt="cloud" />
					<img id="bg1-3" src="https://i.pinimg.com/originals/29/a2/22/29a222d0e480acf061b959b933ede8e9.gif"
						alt="cloud" />
					<img id="bg1-4"
						src="https://media2.giphy.com/media/FHcRX5OWtvIaKTWyTX/giphy.gif?cid=6c09b952ys9xz0oihx6vzec3i9ond0dgxxn5vll8gfnk0riy&ep=v1_stickers_related&rid=giphy.gif&ct=s"
						alt="cloud" />
	...
	document.addEventListener('DOMContentLoaded', (event) => {
		...
		modoEscuroBtn.addEventListener('click', () => {
			...
			if (isDarkMode) {
				...
				modoEscuroImg.style.transition = 'ease-in 1s';
			} else {
	...
	document.addEventListener('DOMContentLoaded', (event) => {
		...
		abrirCarrinhoBtn.addEventListener('click', (event) => {
			...
			if (!carregamentoRealizado) {
				...
				}, 0000); // Ajuste o tempo conforme necessário
			} else {
